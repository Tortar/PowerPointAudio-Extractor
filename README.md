...
You can use exe_extractor folder with which you can run the program, even without installing python : download the script clicking on the 'code' button, create a new empty folder and extract the .zip file there, eventually put the powerpoints on the same folder and click on the file extractor.exe. That's it ! 
